...
public class NonBinaryExpressionTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][]{
            {new ArrayDeque<>(Arrays.asList("4", "+", "(", ")", "+", "3"))},
            {new ArrayDeque<>(Arrays.asList("9", "+", "4", "/"))},
     ...
     * @param infixQueue
     */
    public NonBinaryExpressionTest(Queue<String> infixQueue) {
    ...
    public void testNonBinaryExpression() throws NonMatchingParenthesis, InvalidInputQueueString, NonBinaryExpression, DivisionByZero {
        rp.convertInfixToPostfix(infixQueue);
        fail("NonBinaryExpression Excption was not thrown");
    }
}
